...
<main>
  ...
  <section class="container-form">
    <form action="processo-produto.php" method="post" enctype="multipart/form-data" >
      ...
      <div class="container-radio">
        ...
        <div>
            <label for="almoco">Almoço</label>
            <input type="radio" id="almoco" name="tipo" value="Almoço" checked>
        </div>
      </div>  
      <?php endif?>
